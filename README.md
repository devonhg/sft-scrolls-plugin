...
Do a search-replace accross all files in the pt-API directory and replace SFT_PLUG with your plugins name. This changes various classnames to insure that there is no collisions with other plugins that may happen to use this framework. 
